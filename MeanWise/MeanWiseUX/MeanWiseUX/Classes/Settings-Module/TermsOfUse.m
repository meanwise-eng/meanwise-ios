...
- (void)highlightLetter:(UITapGestureRecognizer*)sender {
    ...
    BOOL flag=[Constant isAppDebugModeOn];
    
    if(flag==NO)
    {
        [FTIndicator showInfoWithMessage:@"Debug Mode Enabled."];
        [Constant setAppDebugMode:TRUE];
    }
    if(flag==YES)
    {
        [FTIndicator showInfoWithMessage:@"Debug Mode Disabled."];
        [Constant setAppDebugMode:false];
