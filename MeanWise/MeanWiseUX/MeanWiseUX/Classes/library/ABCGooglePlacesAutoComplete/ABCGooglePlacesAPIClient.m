...
NSString *const apiKey = @"AIzaSyDPaSy6E9woXJXWQYD3FQm-YjLZgeoz1bU";
...
-(void)retrieveGooglePlaceInformation:(NSString *)searchWord withCompletion:(void (^)(BOOL isSuccess, NSError *error))completion {
    ...
    if ([self.searchResultsCache objectForKey:searchWord]) {
        ...
        NSString *urlString = [NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/autocomplete/json?input=%@&types=(regions)&radius=500&language=en&key=%@",searchWord,apiKey];
