...
-(void)addNewObjects:(NSArray *)inputArray;
{
    ...
    for(int i=0;i<inputArray.count;i++)
    {
        ...
        NSString *userName=[NSString stringWithFormat:@"%@ %@",[[obj first_name] substringToIndex:1],[[obj last_name] substringToIndex:1]];
        ...
        [demo setURLString:obj.profile_photo_small andUserId:obj.userId withUserNameString:userName];
