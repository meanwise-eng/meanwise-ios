...
@implementation DeepLinkPostViewer
...
-(void)setUpWithPostId:(NSDictionary *)postFeedObj withComment:(BOOL)commentFlag
{
    ...
    screenIdentifier=@"DEEPLINKPOST";
    [HMPlayerManager sharedInstance].DeepLinkPost_urlIdentifier=@"";
    refreshIdentifier=[[HMPlayerManager sharedInstance] generateNewDeepLinkRefreshIdentifier];
...
-(void)backBtnClicked:(id)sender
{
    ...
    [[HMPlayerManager sharedInstance] StartKeepKillingDeepLinkVideosIfAvaialble];
...
-(void)playAutomatically
{
    ...
    if(![obj.video_url isEqualToString:[HMPlayerManager sharedInstance].DeepLinkPost_urlIdentifier])
    {
        
        PostFullCell *cell=(PostFullCell *)[feedList cellForItemAtIndexPath:visibleIndexPath];
        [cell playVideoIfAvaialble];
        
        [HMPlayerManager sharedInstance].DeepLinkPost_screenIdentifier=screenIdentifier;
        [HMPlayerManager sharedInstance].DeepLinkPost_urlIdentifier=url;
...
-(void)NotificationPostGoesBack
{
    ...
    [HMPlayerManager sharedInstance].DeepLinkPost_isPaused=true;
    
}
-(void)NotificationPostToFront
{
    NSLog(@"Home screen front");
    [HMPlayerManager sharedInstance].DeepLinkPost_isPaused=false;
