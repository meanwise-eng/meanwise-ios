...
-(void)addNewPost
{
 ...
 /*
    ...
    */
    ...
    NSData *path = [NSData dataWithContentsOfURL:[NSURL URLWithString:[[NSBundle mainBundle] pathForResource:@"mag_app_reducedvid" ofType:@"mp4"]]];
    
    
    
    [manager sendRequestForNewPostWithMedia:dict1 WithMediaData:path andTypeisVideo:YES delegate:self andSelector:@selector(addNewPostResponse:)];
