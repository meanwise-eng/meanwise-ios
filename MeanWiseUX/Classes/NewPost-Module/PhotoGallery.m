...
-(void)setUpBasics
{
    ...
    switchBtn=[[UIButton alloc] initWithFrame:CGRectMake((self.frame.size.width-40)/2,self.frame.size.height - 150, 40, 40)];
...
-(void)setUpCameraSection
{
   ...
   /*
    AMPopTip *cameraTip = [AMPopTip popTip];
    cameraTip.backgroundColor = [UIColor colorWithRed:102/255.0 green:204/255.0 blue:255/255.0 alpha:1.0];
    cameraTip.popoverColor =[UIColor colorWithRed:102/255.0 green:204/255.0 blue:255/255.0 alpha:1.0];
    cameraTip.textColor = [UIColor whiteColor];
    cameraTip.actionAnimation = AMPopTipActionAnimationBounce;
    [cameraTip showText:@"Press and hold to record video or tap once to take photo" direction:AMPopTipDirectionUp maxWidth:200.0 inView:imageViewCameraBack fromFrame:cameraBtnMax.frame];
