...
//        keyImageView.image=[UIImage imageWithContentsOfFile:filePathStr];
    ...
    EditingCancelBtn=[[UIButton alloc] initWithFrame:CGRectMake(0, 20, 40, 40)];
    ...
    [EditingCancelBtn setBackgroundImage:[UIImage imageNamed:@"photoCancelBtn.png"] forState:UIControlStateNormal];
    
    EditingCorrectBtn=[[UIButton alloc] initWithFrame:CGRectMake(0, 0, 25, 25)];
    [self addSubview:EditingCorrectBtn];
    EditingCorrectBtn.center=CGPointMake(self.frame.size.width-20, 35);
