...
-(void)setUp
{
    ...
    locationTXT=[[UITextField alloc] initWithFrame:CGRectMake(10, 0, self.frame.size.width-20, fieldHeight)];
    locationTXT.backgroundColor=[UIColor clearColor];
    locationTXT.textColor=[UIColor blackColor];
    locationTXT.font=[UIFont fontWithName:k_fontSemiBold size:12];
    [view1 addSubview:locationTXT];
...
-(void)setUpNavBarAndAll
{
    ...
    instructionField.text=@"Where are you?";
