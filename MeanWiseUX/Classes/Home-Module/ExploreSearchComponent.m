...
{
    searchTerm=@"";
    segmentView=[[UIView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 50)];
...
//    UIButton *segmentPostsBtn;
 //   UIButton *segmentTopicsBtn;
  //  UIButton *segmentHashtagsBtn;
    ...
    segmentPostsBtn=[[UIButton alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/3, 50)];
    [self addSubview:segmentPostsBtn];
    [segmentPostsBtn setTitle:@"POSTS" forState:UIControlStateNormal];
    segmentPostsBtn.titleLabel.font=[UIFont fontWithName:k_fontSemiBold size:12];
    
    segmentTopicsBtn=[[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width/3, 0, self.frame.size.width/3, 50)];
    ...
    segmentTopicsBtn.titleLabel.font=[UIFont fontWithName:k_fontSemiBold size:12];
    
    segmentHashtagsBtn=[[UIButton alloc] initWithFrame:CGRectMake(2*self.frame.size.width/3, 0, self.frame.size.width/3, 50)];
    ...
    segmentHashtagsBtn.titleLabel.font=[UIFont fontWithName:k_fontSemiBold size:12];
    ...
    tableViewBgView=[[UIView alloc] initWithFrame:CGRectMake(0, 50, self.frame.size.width, self.frame.size.height-40)];
