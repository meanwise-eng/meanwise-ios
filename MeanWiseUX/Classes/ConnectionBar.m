...
-(void)setUpRechability
{
    ...
    if          (remoteHostStatus == NotReachable)      {      self.hasInet=NO;   }
    else if     (remoteHostStatus == ReachableViaWiFi)  {    self.hasInet=YES;  }
    else if     (remoteHostStatus == ReachableViaWWAN)  {    self.hasInet=YES;  }
