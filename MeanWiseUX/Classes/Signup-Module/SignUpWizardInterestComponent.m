...
-(void)setUp
{
    ...
    */
    ...
    layout =  [HorizontalLinearFlowLayout layoutConfiguredWithCollectionView:interestCollectionView
                                                                    itemSize:CGSizeMake(180, 180)
                                                          minimumLineSpacing:0];
    
    
    CGRect collectionViewFrame = CGRectMake(0, (self.bounds.size.height - (self.bounds.size.height*0.5) + 125)/2, self.frame.size.width, self.bounds.size.height*0.5);
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.nameLBL.text=[[[arrayData1 objectAtIndex:indexPath.row] valueForKey:@"name"] uppercaseString];
...
{
    return CGSizeMake(self.frame.size.width*0.7, self.bounds.size.height*0.5);
}
