...
-(void)setUp
{
    ...
    firstNameHeadLBL.font=[UIFont fontWithName:k_fontSemiBold size:15];
    ...
    firstNameField.font = [UIFont fontWithName:k_fontLight size:26.0f];
    ...
    lastNameField.font = [UIFont fontWithName:k_fontLight size:26.0f];
    ...
    firstNameValidationSign=[[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 30, 30)];
    ...
    lastNameValidationSign=[[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 30, 30)];
